...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        uint32 GetArenaTeamId(uint8 slot) const { return (3 == slot ? _custom1v1ArenaTeamInfo[ARENA_TEAM_ID] : GetUInt32Value(PLAYER_FIELD_ARENA_TEAM_INFO_1_1 + (slot * ARENA_TEAM_END) + ARENA_TEAM_ID)); }
        uint32 GetArenaPersonalRating(uint8 slot) const { return (3 == slot ? _custom1v1ArenaTeamInfo[ARENA_TEAM_PERSONAL_RATING] : GetUInt32Value(PLAYER_FIELD_ARENA_TEAM_INFO_1_1 + (slot * ARENA_TEAM_END) + ARENA_TEAM_PERSONAL_RATING)); }
    ...
    private:
		...
		uint32 _custom1v1ArenaTeamInfo[ARENA_TEAM_END];
};
