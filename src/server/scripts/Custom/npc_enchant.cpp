...
Item* PlayerAddItem(Player* player, uint32 item_id)
{
    ...
    {
        player->GetSession()->SendNotification("Por favor, faça o quarto em sua"
            "inventário primeiro.");
        return NULL;
    }
    return item;
...
void Enchant(Player* player, Creature* creature, Item* item, uint32 enchantid)
{
    if (!item)
    {
        player->GetSession()->SendNotification("Por favor, equipar um item primeiro.");
        return;
    }
    ...
    switch (enchantid)
    {
        ...
        case ENCHANT_WEP_MASSACRE:
            ...
            {
                creature->TextEmote("Isso não é uma arma de duas mãos", player, false);
                return;
            }
            break;
        ...
        case ENCHANT_SHIELD_TITANIUM_SPIKE:
            ...
            {
                creature->TextEmote("Isso não é um escudo", player, false);
                return;
            }
            break;
        ...
        case ENCHANT_RANGED_SUN_SCOPE:
            ...
            {
                creature->TextEmote("Isso não é uma arma de longo alcance!", player, false);
                return;
            }
            break;
        default:
    ...
    char* message;
    player->GetSession()->SendNotification("|cff0000FF%s |cffFF0000Encantada com sucesso!", item->GetTemplate()->Name1.c_str());
}
...
class npc_enchantments : public CreatureScript
{
    public:
        ...
        void ShowMainMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-MainHand.png:30|t -> Enchant Weapon", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-MainHand.png:30|t -> Enchant 2H Weapon", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
			player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Ranged.png:30|t -> Enchant Ranged Weapon", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-SecondaryHand.png:30|t -> Enchant Shield", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Head.png:30|t -> Enchant Head", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Shoulder.png:30|t -> Enchant Shoulders", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-Backpack-EmptySlot.png:30|t -> Enchant Back", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Chest.png:30|t -> Enchant Chest", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Wrists.png:30|t -> Enchant Bracers", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Hands.png:30|t -> Enchant Gloves", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Waist.png:30|t -> Enchant Waist", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Legs.png:30|t -> Enchant Legs", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-Feet.png:30|t -> Enchant Feet", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
            if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) >= 450)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface\\PaperDoll\\UI-PaperDoll-Slot-RFinger.png:30|t -> Enchant Rings", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 14);
        ...
        void Show1HWeaponMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Accuracy -> 25 HIT + 25CRIT", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_ACCURACY);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Black Magic -> 250 SPELL HASTE", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_BLACK_MAGIC);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Battlemaster -> CHANCE HEAL ON HIT", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_BATTLEMASTER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Berserking -> 400 AP", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_BERSERKING);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Agility -> 26 AGI", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_AGILITY_1H);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Spirit -> 45 SPIRIT", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_SPIRIT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Executioner -> 120 ARM PEN", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_EXECUTIONER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Icebreaker -> FIRE DAMA. ON HIT", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_ICEBREAKER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Lifeward -> CHANCE HEAL ON HIT", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_LIFEWARD);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Mighty Spellpower -> 63 SP", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_MIGHTY_SPELL_POWER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Mongoose -> 120 AGILITY", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_MONGOOSE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Superior Potency -> 65 AP", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_POTENCY);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Titanguard -> 50 STAMINA", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_TITANGUARD);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Titanium Weapon Chain -> LESS DIRSARM TIME", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_TITANIUM_CHAIN);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Voltar", GOSSIP_SENDER_MAIN, -1);
            player->SEND_GOSSIP_MENU(1, creature->GetGUID());
        }
        ...
        void Show2HWeaponMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Berserking -> 400 AP PROC", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_BERSERKING);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Executioner -> 120 ARM PEN PROC", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_EXECUTIONER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Spellpower -> 81 SP", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_GREATER_SPELL_POWER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Major Agility -> 35 AGI", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_AGILITY_2H);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Massacre -> 110 AP", GOSSIP_SENDER_MAIN,
                ENCHANT_WEP_MASSACRE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Mongoose -> 120 AGI PROC", GOSSIP_SENDER_MAIN, 
                ENCHANT_WEP_MONGOOSE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Voltar", GOSSIP_SENDER_MAIN, -1);
            player->SEND_GOSSIP_MENU(1, creature->GetGUID());
        }
        ...
        void ShowShieldMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Intellect -> 25 INTEL", GOSSIP_SENDER_MAIN, 
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Resilience -> 12 RESIL", GOSSIP_SENDER_MAIN,
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Blissful Mending -> 30 SP + 10 Mp5", GOSSIP_SENDER_MAIN, 
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Dominance -> 30 SP + 20 CRIT", GOSSIP_SENDER_MAIN, 
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Torment -> 29 SP + 20 Resil", GOSSIP_SENDER_MAIN,
                ENCHANT_HEAD_TORMENT);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Triumph -> 50 AP + 20 Resil", GOSSIP_SENDER_MAIN, 
        ...
        void ShowShouldersMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Axe -> 40 AP + 15 Crit", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_GREATER_AXE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Crag -> 24 SP + 8 Mp5", GOSSIP_SENDER_MAIN, 
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Inscription of the Storm -> 24 SP+ 15 Crit", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_GREATER_STORM);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Inscription of Dominance -> 23 SP + 15 Resil", GOSSIP_SENDER_MAIN, 
                ENCHANT_SHOULDER_DOMINANCE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Inscription of Triumph -> 40 AP + 15 Resil", GOSSIP_SENDER_MAIN, 
        ...
        void ShowChestMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "10 ALL STATS", GOSSIP_SENDER_MAIN, 
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Assault -> 50 AP", GOSSIP_SENDER_MAIN, 
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Superior Spellpower ->30 SP", GOSSIP_SENDER_MAIN, 
        ...
        void ShowGlovesMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Spellpower -> 23 SP", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_EXCEPTIONAL_SPELLPOWER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Expertise -> 15 Expertise", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_EXPERTISE);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Greater Assault -> 44 AP", GOSSIP_SENDER_MAIN, 
                ENCHANT_GLOVES_CRUSHER);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Major Agility -> 20 AGI", GOSSIP_SENDER_MAIN, 
