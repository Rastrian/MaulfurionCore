...
VisualData vData[] =
{
    ...
    { 1, 2, GOSSIP_ICON_TALK, 0, "Proxima pagina." },
    ...
    { 2, 3, GOSSIP_ICON_TALK, 0, "Proxima pagina." },
    { 2, 1, GOSSIP_ICON_TALK, 0, "Voltar pagina." },
    ...
    { 3, 2, GOSSIP_ICON_TALK, 0, "Voltar pagina." },
};
...
public:
    ...
    {
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "=== Efeitos nas Armas ===", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Main-Hand (Mao Primaria)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Off-Hand (Mao secundaria | Shield)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Fechar Menu", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "=========================", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
